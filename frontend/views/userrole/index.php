                        ...
                        <div class="card-title">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="text-align: end;" id="button_show">
                                    <?= Html::a('Add User Role', null, ['onclick' => 'show_add_section()', 'class' => 'btn btn-small', 'title' => 'Add New User Role'])
                                    ?>
                                </div>
                            </div>
                            <hr />
                        </div>
                        <div style="display: <?php echo $display; ?>;" id="add_userrole" class="animate fadeRight">
                            <?= $this->render('_form', [
                                'model' => $model,
