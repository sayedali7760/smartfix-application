                        ...
                        <div class="card-title">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="add_button_cls" style="text-align: end;">
                                    <?= Html::a('Add User', null, ['onclick' => 'show_add_section()', 'add', 'class' => 'btn btn-small', 'title' => Yii::t('app', 'Add New User')])
                                    ?>
                                </div>
                                <!-- <div class="col-md-6" id="back_button_cls" style="text-align: end;display:none">
                                    <a class="btn btn-small waves-effect waves-light red" href="/bm-imprint/usermanage/index" title="Back">Back</a>
                                </div> -->
                            </div>
                            <hr />
                        </div>
                            ...
                            <?= GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'filterInputOptions' => ['prompt' => 'Search With User Role....', 'style' => 'color#6c6666;font-size: 11px;height: 36px;', 'class' => 'form-control'],
